...
#define Dollar                                                                 \
  2 // special char for the parsing algorithm, must be the highest special char
...
#define SABYTES                                                                \
  IBYTES // bytes used to write a suffix array value in the output .sa file
...
FILE *open_aux_file_num(const char *base, const char *ext, const int,
                        const char *mode);
